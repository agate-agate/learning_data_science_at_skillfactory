...
def game_core_v4(secret_number, show_path=False):
    ...
    На выходе - словарь со статистикой Игрока за одну игру (за один
    матч)
    Поля словаря:
        ...
        path -- список чисел - (опциональное поле - оно не показывается
                ...
                ПредположенныеЧисла которые обдумывал Игрок (партию); в
                некоторых случаях тут может быть больше чисел чем было
                сделано Попыток - потому что Игрок не все числа решился
                Огласить вслух.
